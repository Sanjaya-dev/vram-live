                ...
                <form class="w-full" action="{{ route('admin.items.update', $item->id) }}" method="post"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Brand item. Contoh: Porsche .Wajib di isi
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('features') ?? $item->features }}" name="features"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" placeholder="features">
                            <div class="mt-2 text-sm text-gray-500">
                                features item. Contoh: Fitur 1, Fitur 2, Fitur 3, dan di pisahkan dengan (,).
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                foto item. Lebih dari satu foto (Optional).
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-3 px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Brand item. Contoh: 1000000 .Wajib di isi
                            </div>
                        </div>
