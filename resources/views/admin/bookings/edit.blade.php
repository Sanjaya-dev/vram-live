<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                {{-- jika terjadi error pada penginputan maka bagian ini akan di jalankan --}}
                @if ($errors->any())
                ...
                <form class="w-full" action="{{ route('admin.bookings.update', $booking->id) }}" method="post"
                    ...
                    {{-- membuat token saat pengiriman data --}}
                    @csrf
                    @method('PUT')
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Nama. Contoh: Eric  dsb. Wajib diisi. Maksimal 255 karakter.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('address') ?? $booking->address }}" name="address"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" placeholder="JL.Merdeka" required>
                            <div class="mt-2 text-sm text-gray-500">
                                Alamat Booking. Contoh: Alaamt 1, Alamat 2 dsb. Wajib diisi.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('city') ?? $booking->city }}" name="city"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" placeholder="Jakarta" required>
                            <div class="mt-2 text-sm text-gray-500">
                                Kota booking. Contoh: Jakarta dsb. Wajib diisi.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('zip') ?? $booking->zip }}" name="zip"
                                ...
                                id="grid-last-name" type="text" placeholder="Nama" required>
                            <div class="mt-2 text-sm text-gray-500">
                                Kode Pos booking. Contoh: 12345. Wajib diisi.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Status booking. Contoh: Pandding.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <select name="payment_status" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                                ...
                                <option value="failed"{{$booking->payment_status == 'failed' ? 'selected' : ''}}>Filed</option>
                                <option value="expired"{{$booking->payment_status == 'expired' ? 'selected' : ''}}>Expired</option>
                            </select>
                            
                            <div class="mt-2 text-sm text-gray-500">
                                Status Pembayaran. Contoh: Success.
                            </div>
                        </div>
                    </div>
